...
namespace Hanafalah\ModuleEncoding\Facades;
 ...
 */
class ModuleEncoding extends \Illuminate\Support\Facades\Facade
{
  /**
  ...
  {
    return \Hanafalah\ModuleEncoding\Contracts\ModuleEncoding::class;
  }
}
